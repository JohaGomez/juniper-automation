...
boolean hotelVisible = WebUI.waitForElementVisible(findTestObject('Euromundo/circuitos/repository_circuitos_inter/select_hotel_inter_circuitos'), 10, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Euromundo/circuitos/repository_circuitos_inter/select_hotel_inter_circuitos'))
...
if (!(hotelVisible)) {
    ...
    WebUI.click(findTestObject('Euromundo/book_steps/button_search_inter'))
    WebUI.waitForElementVisible(findTestObject('Euromundo/circuitos/repository_circuitos_inter/select_hotel_inter_circuitos'), 10)
	WebUI.click(findTestObject('Euromundo/circuitos/repository_circuitos_inter/select_hotel_inter_circuitos'))
}


//Guardar titulo del hotel para después comparar
TestObject tituloObj = new TestObject("tituloDinamico")
tituloObj.addProperty(
	"xpath",
	ConditionType.EQUALS,
	"//*[@id='main-content']/div/div[2]/div[1]/div/div/div/article/section[1]/div/div[2]/div[1]/div[1]/div[1]/div[1]")
...
otroTituloObj.addProperty(
	"xpath",
	ConditionType.EQUALS,
	"//*[@id='main-content']/div[2]/div/div[3]/div[1]/div/div/div/section/div/div[2]/div[1]/div/div[1]/div[1]")
