...
WebUI.waitForElementClickable(findTestObject('Euromundo/book_steps/origin_date_inter'), 15)
...
if (!(WebUI.waitForElementVisible(findTestObject('Euromundo/circuitos/repository_circuitos_inter/select_hotel_inter_circuitos'), 10, FailureHandling.OPTIONAL))) {
...
WebUI.waitForElementVisible(findTestObject('Euromundo/hotels/select_hotel_change'), 10)
