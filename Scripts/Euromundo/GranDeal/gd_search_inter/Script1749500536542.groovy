...
WebUI.waitForElementClickable(findTestObject('Euromundo/repository_GD_Inter/menu_gd_inter'), 10)

WebUI.mouseOver(findTestObject('Euromundo/repository_GD_Inter/menu_gd_inter'))

WebUI.click(findTestObject('Euromundo/repository_GD_Inter/select_international'))
...
WebUI.selectOptionByValue(findTestObject('Euromundo/repository_GD_Inter/input_destination_inter'), '184911', true)

WebUI.selectOptionByValue(findTestObject('Euromundo/repository_GD_Inter/select_origin_inter'), '35908', true)

WebUI.setText(findTestObject('Euromundo/repository_GD_Inter/origin_date_inter'), '01/08/2025')
...
boolean hotelVisible = WebUI.waitForElementVisible(findTestObject('Euromundo/select_hotel'), 10, FailureHandling.OPTIONAL)
...
if (!(hotelVisible)) {
    ...
    WebUI.waitForElementVisible(findTestObject('Euromundo/hotel_steps/button_select_hotel'), 10)
