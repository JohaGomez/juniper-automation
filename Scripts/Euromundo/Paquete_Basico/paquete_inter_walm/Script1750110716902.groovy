...
CustomKeywords.'utils.FechaUtils.setFechaSabadoEnUnMes'('Euromundo/book_steps/origin_date_inter') // 📅 Fecha
...
WebUI.click(findTestObject('Euromundo/book_steps/button_prebook_walm'))
