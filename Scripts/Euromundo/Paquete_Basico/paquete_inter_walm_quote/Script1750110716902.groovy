...
boolean hotelVisible = WebUI.waitForElementVisible(findTestObject('Euromundo/book_steps/button_prebook_gd_inter'), 15, FailureHandling.OPTIONAL)
...
if (!(hotelVisible)) {
    ...
    WebUI.click(findTestObject('Euromundo/book_steps/button_search_inter'))
    WebUI.waitForElementVisible(findTestObject('Euromundo/book_steps/button_prebook_gd_inter'), 15)
}

WebUI.click(findTestObject('Euromundo/book_steps/button_prebook_gd_inter'))

// 🔐 Continuar con prebook
