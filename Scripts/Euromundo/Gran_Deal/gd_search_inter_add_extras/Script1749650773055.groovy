...
WebUI.click(findTestObject('Euromundo/services/select_service_inter'))

//Guardar titulo del extra agregado para después comparar
TestObject tituloObj = new TestObject("tituloDinamico")
tituloObj.addProperty("xpath", ConditionType.EQUALS, "(//div[contains(@class,'result-option--selected')]//i[contains(@class,'glyphicon-service-search')]/ancestor::div[contains(@class,'result-option-package__item-product')])[1]")
