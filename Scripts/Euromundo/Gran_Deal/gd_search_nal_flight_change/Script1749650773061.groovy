...
WebUI.waitForElementClickable(findTestObject('Euromundo/gran_deal/repository_GD_nal/input_Origin'), 30)
WebUI.selectOptionByValue(findTestObject('Euromundo/gran_deal/repository_GD_nal/input_Origin'), '35908', true) // CDMX
CustomKeywords.'utils.FechaUtils.setFechaAleatoriaDesdeUnMesFuturo'('Euromundo/gran_deal/repository_GD_nal/origin_Date') // 📅 Fecha
...
// ✈️ Cambio de vuelos
CustomKeywords.'helpers.WebUIHelper.safeClick'(findTestObject('Euromundo/flights/button_flight_change_gd'))
CustomKeywords.'helpers.WebUIHelper.safeClick'(findTestObject('Euromundo/flights/radiobutton_flight_change'))
...
CustomKeywords.'helpers.WebUIHelper.safeClick'(findTestObject('Euromundo/flights/button_select_flight'))
