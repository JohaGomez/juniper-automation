...
WebUI.click(findTestObject('Euromundo/seguros/repository_seguros_nal/set_pax_adl_insurance'))

WebUI.selectOptionByValue(findTestObject('Euromundo/widget/set_Adults'), '3', false)
