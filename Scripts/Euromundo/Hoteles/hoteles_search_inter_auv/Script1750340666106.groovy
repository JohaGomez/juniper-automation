...
WebUI.scrollToElement(findTestObject('Euromundo/book_steps/button_finalization_prebook_hoteles'), 10)
...
// ✅ Validar y seleccionar "Información importante" si está presente
...
if (WebUI.verifyElementPresent(importantInfoCheckbox, 5, FailureHandling.OPTIONAL)) {
	KeywordUtil.logInfo('🟩 Checkbox "Important Info" encontrado. Seleccionando...')
	WebUI.click(importantInfoCheckbox)
} else {
	KeywordUtil.logInfo('⚠️ Checkbox "Important Info" NO encontrado. Se continúa con el flujo.')
}
