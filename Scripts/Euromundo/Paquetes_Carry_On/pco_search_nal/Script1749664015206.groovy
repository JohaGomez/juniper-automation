...
WebUI.click(findTestObject('Euromundo/paquetes_carry_on/repository_pco_nal/select_pco_nal'))
...
WebUI.setText(findTestObject('Euromundo/pax_page/set_expiration_passport_pax1'), '21/09/2031')
...
WebUI.setText(findTestObject('Euromundo/pax_page/set_expiration_passport_pax2'), '21/09/2031')
