...
// En ambos casos continúa con button_finalization
...
WebUI.setText(findTestObject('Euromundo/pax_page/set_document_passport_pax1'), '42341212')

WebUI.setText(findTestObject('Euromundo/pax_page/set_email_extended_pax1'), 'johana.gomez@ejuniper.com')
...
WebUI.setText(findTestObject('Euromundo/pax_page/set_document_passport_pax2'), '4534522')

WebUI.setText(findTestObject('Euromundo/pax_page/set_email_extended_pax2'), 'johana.gomez@ejuniper.com')
