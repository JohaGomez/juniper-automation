...
// ✈️ Seleccionar paquete - Localiza el botón "Reservar" que esté en el mismo contenedor del título que contenga "20 HRS"
TestObject btnReservar = new TestObject('btnReservar20Hrs')
btnReservar.addProperty('xpath', ConditionType.EQUALS,
	"//div[contains(@class,'info-card__title') and contains(normalize-space(.), '20 HRS')]" +
	"/following::button[contains(@class,'result-option__book-button')][1]"
)

// Hacer clic en el botón
WebUI.click(btnReservar)
