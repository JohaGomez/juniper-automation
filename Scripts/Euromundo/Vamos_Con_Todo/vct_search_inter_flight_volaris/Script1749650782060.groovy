...
if (!(WebUI.waitForElementVisible(findTestObject('Euromundo/vamos_con_todo/repository_vct_inter/select_hotel_vct_inter'), 10, FailureHandling.OPTIONAL))) {
...
WebUI.waitForElementClickable(findTestObject('Euromundo/book_steps/button_finalization_book'), 15)
