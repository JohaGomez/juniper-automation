...
boolean hotelVisible = WebUI.waitForElementVisible(findTestObject('Euromundo/vamos_con_todo/repository_vct_inter/select_hotel_vct_inter'), 
...
if (!(hotelVisible)) {
    ...
    WebUI.waitForElementVisible(findTestObject('Euromundo/vamos_con_todo/repository_vct_inter/select_hotel_vct_inter'), 
        10)
