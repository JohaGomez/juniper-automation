...
// ⏳ Esperar resultados
boolean hotelVisible = WebUI.waitForElementVisible(findTestObject('Euromundo/europamundo/repository_europamundo/select_package'), 10, FailureHandling.OPTIONAL)
if (!hotelVisible) {
...
// 🚐 Transferencias
WebUI.selectOptionByValue(findTestObject('Euromundo/europamundo/repository_europamundo/input_arrival_transfers_walm'), 'C2EE3F4E7262FE61CD0C3D39B8CA8A5A', true)
WebUI.selectOptionByValue(findTestObject('Euromundo/europamundo/repository_europamundo/input_departure_transfers_walm'), 'C2EE3F4E7262FE61CD0C3D39B8CA8A5A', true)
...
// 📢 Validación mensaje cancelación
...
WebUI.comment("⏱️ Tiempo total del flujo de reserva WALM: ${durationSeconds} segundos.")
