...
// 🚐 Transferencias
WebUI.selectOptionByValue(findTestObject('Euromundo/europamundo/repository_europamundo/input_arrival_transfers_oti'), 'C2EE3F4E7262FE61CD0C3D39B8CA8A5A', true)
WebUI.selectOptionByValue(findTestObject('Euromundo/europamundo/repository_europamundo/input_departure_transfers_oti'), 'C2EE3F4E7262FE61CD0C3D39B8CA8A5A', true)
...
WebUI.comment("⏱️ Tiempo total del flujo de reserva OTI: ${durationSeconds} segundos.")
