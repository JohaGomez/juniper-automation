...
// ➡️ Continuar a datos de pasajeros
CustomKeywords.'helpers.WebUIHelper.safeClick'(findTestObject('Euromundo/europamundo/repository_europamundo/button_continue'))

// 👤 Pasajeros
WebUI.waitForElementClickable(findTestObject('Euromundo/book_steps/button_finalization_prebook'), 10)

WebUI.selectOptionByValue(findTestObject('Euromundo/pax_page/select_title_new_pax1'), 'MR', false)
...
WebUI.setText(findTestObject('Euromundo/pax_page/input_birthday_extended3_pax1'), '25/10/1990')

WebUI.setText(findTestObject('Euromundo/pax_page/set_document_extended3_pax1'), '1232434')

WebUI.selectOptionByValue(findTestObject('Euromundo/pax_page/select_title_new_pax2'), 'MRS', true)

WebUI.setText(findTestObject('Euromundo/pax_page/input_name_extended2_pax2'), 'Johana')

WebUI.setText(findTestObject('Euromundo/pax_page/input_surname_extended2_pax2'), 'Gomez')

WebUI.setText(findTestObject('Euromundo/pax_page/input_birthday_extended3_pax2'), '18/09/1995')

WebUI.setText(findTestObject('Euromundo/pax_page/set_document_extended3_pax2'), '43534234')
...
// 🕒 Fin del cronómetro y resultado
long endTime = System.currentTimeMillis()

double durationSeconds = (endTime - startTime) / 1000.0

WebUI.comment("⏱️ Tiempo total del flujo de reserva: $durationSeconds segundos.")
